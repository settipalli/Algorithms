...
# Name          :   merge.py
#
# Description   :   This script implements the merge sort that was first
#                   implemented by John von Neumann in the year 1945.
#
# Version       :   1.0.0
#
...
class MergeSort:
    ...
    """
    Based on the input specified by the user, MergeSort can be utilized to sort
    ...
    def sort(self, seq, asc=True):
        ...
        lft = seq[:mid]
        rgt = seq[:mid]
        if len(lft) > 1: sort(lft, asc)
        if len(rgt) > 1: sort (rgt, asc)
    ...
    def main(self):
        ...
        self.log(level="info",
                 msg="=============================================")
        self.log(level="info", msg="MergeSort: Logger initialized.")
